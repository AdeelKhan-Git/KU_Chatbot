...
# Initialize models
llm = OllamaLLM(model="mistral-q4_k_m", model_kwargs={"num_predict": 150},num_gpu=1,keep_alive='10m',streaming=True)
...
def chatbot_response(user,question):
    ...
    try:
        ...
        if "I don't have information about that" not in final_reply:
